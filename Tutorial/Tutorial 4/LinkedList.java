...
public class LinkedList<E>{
    ...
    public void addFirst(E item){
        /*
        e) Condition to consider: Whether the list contains any node. If it doesn't, the tail should be set to this new node.
    ...
    public void addLast(E item){
        /*
        e) Condition to consider: Whether the list contains any node. If it doesn't, the head should be set to this new node.

        f) Set the next to the tail to the newNode
    ...
    public void add(int index, E item){
        /*
        e) Condition to consider: Throw an exception when index<0 || index>size. Add the node otherwise.
    ...
    public E removeLast(){
        ...
        if(head.next == null){
            ...
            Node<E> prev = node(size-2); //node before tail with index: size-2
            prev.next = null;
            tail = prev;
            size--;
        }
    ...
    public void remove(int index) { //# returnType: E? （F)
        /*
        e) Condition to consider: Throw IndexOutOfBoundsException when index<0 || index>size-1
        ...
        if (index == 0) {
            ...
            size--;
            System.out.println(elem); //#?return (F)
        }
    }
